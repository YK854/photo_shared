...
Photo.create!(
  [
    ...
    {picture: File.open("./app/assets/images/seed-img/Evelyn/Evelyn-img1.jpg"), title: 'シティ', description: 'この文章はダミーこの文章はダミーです。', tag_list: '都市,アメリカ', user_id: users[2].id },
    ...
    {picture: File.open("./app/assets/images/seed-img/Evelyn/Evelyn-img3.jpg"), title: 'ニューヨーク', description: 'この文章はダミーこの文章はダミーです。', tag_list: '都市,道路', user_id: users[2].id },
    ...
    {picture: File.open("./app/assets/images/seed-img/Andy/Andy-img5.jpg"), title: '冬の駅', description: 'この文章はダミーこの文章はダミーです。', tag_list: '鉄道,男性', user_id: users[6].id },
